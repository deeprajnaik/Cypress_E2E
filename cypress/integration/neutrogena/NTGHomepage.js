...
class Homepage {
    ...
    //verifyOverlay() {
       // cy.wait(2000)
        //cy.get('#yie-overlay-wrapper-32bac6a4-e9f6-5dea-aefb-de2cd6ebea3f > iframe')
        //cy.wait(2000)
        //cy.get('#yie-close-button-badbaacf-fbb0-5972-82b7-fea7e9744210').click()
        //cy.get('#q').click()
    //}
    verifyHeaderMenu() {
        cy.get('#q').click()
    ...
    verifyMenuLinks() {
        ...
        //cy.get('#yie-close-button-9cb354f2-edd8-50d1-b325-72359d1cbe08').click()
